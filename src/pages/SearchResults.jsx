...
const SearchResults = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-20 pt-20">
      ...
      {/* Search Bar — dark header matching site design */}
      <div className="bg-[#064E3B] sticky top-[72px] z-30 shadow-lg">
         <div className="container-custom py-3">
             <div className="flex flex-col md:flex-row items-center gap-3">
                 <Button variant="ghost" size="sm" onClick={() => navigate(-1)} className="shrink-0 hidden md:flex text-green-200 hover:text-white hover:bg-white/10">
             ...
             <div className="flex flex-col gap-8">
                 ...
                 <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-5 flex flex-wrap gap-6 items-center justify-between">
                     <div className="flex flex-wrap gap-6 items-center">
                        <div className="flex flex-col">
                            ...
                            <span className="font-bold text-lg text-gray-900">{tripDetails.from.name_en}</span>
                        </div>
                        ...
                        <div className="flex flex-col">
                            ...
                            <span className="font-bold text-lg text-gray-900">{tripDetails.to.name_en}</span>
                        </div>
                     </div>
                     <div className="flex gap-3 text-sm text-green-700 bg-green-50 px-4 py-2 rounded-xl border border-green-100 font-semibold">
                 ...
                 <div>
                     <h2 className="text-xl font-bold text-gray-900 mb-6 flex items-center gap-3">
                        Available Vehicles
                        <span className="bg-green-50 text-green-700 px-3 py-0.5 rounded-full text-sm font-bold border border-green-100">{cars.length}</span>
                     </h2>
